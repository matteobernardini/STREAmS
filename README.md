...
`nxmax  nymax  nzmax` integer numbers defining the number of grid nodes along each direction
 ...
 `rm      re (friction)  twall/taw` Mach number, <img src="https://rawgit.com/in	git@github.com:matteobernardini/STREAmS/master/svgs/1f71bd9db75247d7e8fed8df71d9e9f8.svg?invert_in_darkmode" align=middle width=27.55203pt height=22.38192pt/> number, and the ratio between wall temperature and
...
2) <img src="https://rawgit.com/in	git@github.com:matteobernardini/STREAmS/master/svgs/e3a9a01189dcd6e5f33eeafb6d00056a.svg?invert_in_darkmode" align=middle width=30.61443pt height=24.56553pt/> wall-normal coordinate normalized with the inlet boundary layer thickness
3) <img src="https://rawgit.com/in	git@github.com:matteobernardini/STREAmS/master/svgs/09a4eb9ca66b0dde022422feeb68d606.svg?invert_in_darkmode" align=middle width=33.50193pt height=24.56553pt/> the Favre averaged streamwise velocity component, normalized with the free-stream velocity
4) <img src="https://rawgit.com/in	git@github.com:matteobernardini/STREAmS/master/svgs/b8d101a623e31826e689ce804017c38b.svg?invert_in_darkmode" align=middle width=32.64954pt height=24.56553pt/> the Favre averaged wall-normal velocity  component, normalized with the free-stream velocity
5) <img src="https://rawgit.com/in	git@github.com:matteobernardini/STREAmS/master/svgs/368d663ad6f8d1f9c03a3b43ddc750bc.svg?invert_in_darkmode" align=middle width=36.30264pt height=24.56553pt/> the Favre averaged spanwise velocity  component, normalized with the free-stream velocity
### cf files
