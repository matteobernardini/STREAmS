...
!   Derivatives of conservative variables
    dwdy1 = (-1.5_mykind*w_gpu(1,i,1,k)+2._mykind*w_gpu(1,i,2,k)-0.5_mykind*w_gpu(1,i,3,k))
    dwdy2 = (-1.5_mykind*w_gpu(2,i,1,k)+2._mykind*w_gpu(2,i,2,k)-0.5_mykind*w_gpu(2,i,3,k))
    dwdy3 = (-1.5_mykind*w_gpu(3,i,1,k)+2._mykind*w_gpu(3,i,2,k)-0.5_mykind*w_gpu(3,i,3,k))
    dwdy4 = (-1.5_mykind*w_gpu(4,i,1,k)+2._mykind*w_gpu(4,i,2,k)-0.5_mykind*w_gpu(4,i,3,k))
    dwdy5 = (-1.5_mykind*w_gpu(5,i,1,k)+2._mykind*w_gpu(5,i,2,k)-0.5_mykind*w_gpu(5,i,3,k))
...
!   Eigenvalues (killing the negative ones)
    ...
    ev5       =  ev2
!   Derivatives of conservative variables
    dwdy1 = (1.5_mykind*w_gpu(1,i,ny,k)-2._mykind*w_gpu(1,i,ny-1,k)+0.5_mykind*w_gpu(1,i,ny-2,k))
    dwdy2 = (1.5_mykind*w_gpu(2,i,ny,k)-2._mykind*w_gpu(2,i,ny-1,k)+0.5_mykind*w_gpu(2,i,ny-2,k))
    dwdy3 = (1.5_mykind*w_gpu(3,i,ny,k)-2._mykind*w_gpu(3,i,ny-1,k)+0.5_mykind*w_gpu(3,i,ny-2,k))
    dwdy4 = (1.5_mykind*w_gpu(4,i,ny,k)-2._mykind*w_gpu(4,i,ny-1,k)+0.5_mykind*w_gpu(4,i,ny-2,k))
    dwdy5 = (1.5_mykind*w_gpu(5,i,ny,k)-2._mykind*w_gpu(5,i,ny-1,k)+0.5_mykind*w_gpu(5,i,ny-2,k))
!   Projection on the eigendirections
!   dwcdy1 = 0._mykind
!   dwcdy1 = dwcdy1 + el_1_1 * dwdy1 
!   dwcdy1 = dwcdy1 + el_1_2 * dwdy2 
